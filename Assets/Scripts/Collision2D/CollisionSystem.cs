...
namespace Lockstep.Collision2D {
    ...
    public partial class CollisionSystem : ICollisionSystem {
        ...
        public void DoUpdate(LFloat deltaTime){
            ...
            UnityEngine.Profiling.Profiler.BeginSample("UpdateObj");
            ...
            ////0.32~0.42ms
            UnityEngine.Profiling.Profiler.BeginSample("CheckCollision");
            foreach (var val in tempLst) {
                val.IsMoved = false;
                var bound = val.GetBounds();
            ...
            UnityEngine.Profiling.Profiler.EndSample();
            UnityEngine.Profiling.Profiler.BeginSample("CheckLastFrameCollison");
